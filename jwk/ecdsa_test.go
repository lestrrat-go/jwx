...
func TestECDSA(t *testing.T) {
	...
	t.Run("Marshal Unmarshal Private Key", func(t *testing.T) {
       ...
       [
		...
		expectedPrivKey := `{"crv":"P-256","d":"870MB6gfuTJ4HtUnUvYMyJpr5eUZNP4Bk43bVdj3eAE","key_ops":["verify"],"kty":"EC","x":"MKBCTNIcKUSDii11ySs3526iDZ8AiTo7Tu6KPAqv7D4","y":"4Etl6SRW2YiLUrN5vfvVHuhp7x8PxltmWWlbbM4IFyM"}`
