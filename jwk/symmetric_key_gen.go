...
type SymmetricKey interface {
	...
	// FromRaw initializes the key internals from a Go native key type of []byte
	FromRaw([]byte) error
...
func (v *symmetricKey) DecodeCtx() DecodeCtx {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.dc
}

func (v *symmetricKey) SetDecodeCtx(dc DecodeCtx) {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.dc = dc
}

func (v *symmetricKey) decodeExtraField(name string, dec *json.Decoder, dst interface{}) error {
	if dc := v.dc; dc != nil {
...
func (v *symmetricKey) Get(key string, dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
func (v *symmetricKey) getNoLock(key string, dst interface{}, raw bool) error {
	switch key {
	case AlgorithmKey:
...
func (v *symmetricKey) Set(key string, value interface{}) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	switch key {
	case AlgorithmKey:
...
func (v *symmetricKey) Has(name string) bool {
	switch name {
	case AlgorithmKey:
...
func (v *symmetricKey) HasAlgorithm() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.algorithm != nil
}
...
func (v *symmetricKey) HasKeyID() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyID != nil
}
...
func (v *symmetricKey) HasKeyOps() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyOps != nil
}
...
func (v *symmetricKey) HasKeyType() bool {
	return true
}

// HasKeyUsage returns true if the field `use` has been populated
func (v *symmetricKey) HasKeyUsage() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyUsage != nil
}
...
func (v *symmetricKey) HasX509CertChain() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertChain != nil
}
...
func (v *symmetricKey) HasX509CertThumbprint() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprint != nil
}
...
func (v *symmetricKey) HasX509CertThumbprintS256() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprintS256 != nil
}
...
func (v *symmetricKey) HasX509URL() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509URL != nil
}

// HasOctets returns true if the field `k` has been populated
func (v *symmetricKey) HasOctets() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.octets != nil
}

func (v *symmetricKey) Algorithm() jwa.KeyAlgorithm {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.algorithm; val != nil {
		return *val
...
func (v *symmetricKey) KeyID() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyID; val != nil {
		return *val
...
func (v *symmetricKey) KeyOps() KeyOperationList {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyOps; val != nil {
		return *val
...
func (v *symmetricKey) KeyType() jwa.KeyType {
	return jwa.OctetSeq
}

func (v *symmetricKey) KeyUsage() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyUsage; val != nil {
		return val.Get()
...
func (v *symmetricKey) X509CertChain() *cert.Chain {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertChain; val != nil {
		return val
...
func (v *symmetricKey) X509CertThumbprint() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprint; val != nil {
		return *val
...
func (v *symmetricKey) X509CertThumbprintS256() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprintS256; val != nil {
		return *val
...
func (v *symmetricKey) X509URL() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509URL; val != nil {
		return *val
...
func (v *symmetricKey) Octets() []byte {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.octets; val != nil {
		return val.Bytes()
...
func (v *symmetricKey) Remove(key string) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *symmetricKey) Clone(dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
// MarshalJSON serializes symmetricKey into JSON.
// All pre-declared fields are included as long as a value is
// assigned to them, as well as all extra fields. All of these
// fields are sorted in alphabetical order.
func (v *symmetricKey) MarshalJSON() ([]byte, error) {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
// UnmarshalJSON deserializes a piece of JSON data into symmetricKey.
//
...
func (v *symmetricKey) UnmarshalJSON(data []byte) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.algorithm = nil
	v.keyID = nil
