...
type DilithiumPublicKey interface {
	Key
	X() ([]byte, bool)
}
...
var _ DilithiumPublicKey = &dilithiumPublicKey{}
var _ Key = &dilithiumPublicKey{}

func newDilithiumPublicKey() *dilithiumPublicKey {
...
func (h dilithiumPublicKey) KeyType() jwa.KeyType {
	return jwa.MLWE()
}

func (h dilithiumPublicKey) IsPrivate() bool {
	return false
}

func (h *dilithiumPublicKey) Algorithm() (jwa.KeyAlgorithm, bool) {
	if h.algorithm != nil {
...
func (h *dilithiumPublicKey) KeyID() (string, bool) {
	if h.keyID != nil {
		return *(h.keyID), true
	}
	return "", false
...
func (h *dilithiumPublicKey) KeyOps() (KeyOperationList, bool) {
	if h.keyOps != nil {
...
func (h *dilithiumPublicKey) KeyUsage() (string, bool) {
	if h.keyUsage != nil {
...
func (h *dilithiumPublicKey) X() ([]byte, bool) {
	if h.x != nil {
		return h.x, true
	}
	return nil, false
...
func (h *dilithiumPublicKey) X509CertChain() (*cert.Chain, bool) {
	return h.x509CertChain, true
}

func (h *dilithiumPublicKey) X509CertThumbprint() (string, bool) {
...
func (h *dilithiumPublicKey) X509CertThumbprintS256() (string, bool) {
...
func (h *dilithiumPublicKey) X509URL() (string, bool) {
	if h.x509URL != nil {
...
func (h *dilithiumPublicKey) Has(name string) bool {
	h.mu.RLock()
	defer h.mu.RUnlock()
	switch name {
	case AlgorithmKey:
...
func (h *dilithiumPublicKey) Get(name string, dst interface{}) error {
	h.mu.RLock()
	defer h.mu.RUnlock()
	switch name {
	case KeyTypeKey:
		if err := blackmagic.AssignIfCompatible(dst, h.KeyType()); err != nil {
			return fmt.Errorf(`dilithiumPublicKey.Get: failed to assign value for field %q to destination object: %w`, name, err)
		}
	case AlgorithmKey:
		if h.algorithm == nil {
...
func (h *dilithiumPublicKey) Set(name string, value interface{}) error {
	h.mu.Lock()
	defer h.mu.Unlock()
	return h.setNoLock(name, value)
}

func (h *dilithiumPublicKey) setNoLock(name string, value interface{}) error {
	switch name {
	case "kty":
		return nil
	case AlgorithmKey:
	...
	case DilithiumXKey:
		...
		return fmt.Errorf(`invalid value for %s key: %T`, DilithiumXKey, value)
	case X509CertChainKey:
...
func (k *dilithiumPublicKey) Remove(key string) error {
	k.mu.Lock()
	defer k.mu.Unlock()
	switch key {
	case AlgorithmKey:
...
func (k *dilithiumPublicKey) Clone() (Key, error) {
	key, err := cloneKey(k)
	if err != nil {
		return nil, fmt.Errorf(`dilithiumPublicKey.Clone: %w`, err)
	}
	return key, nil
}

func (k *dilithiumPublicKey) DecodeCtx() json.DecodeCtx {
	k.mu.RLock()
	defer k.mu.RUnlock()
	return k.dc
}

func (k *dilithiumPublicKey) SetDecodeCtx(dc json.DecodeCtx) {
	k.mu.Lock()
	defer k.mu.Unlock()
	k.dc = dc
}

func (h *dilithiumPublicKey) UnmarshalJSON(buf []byte) error {
	h.mu.Lock()
	defer h.mu.Unlock()
	h.algorithm = nil
	h.keyID = nil
		...
		case string: // Objects can only have string keys
			...
			case DilithiumXKey:
				if err := json.AssignNextBytesToken(&h.x, dec); err != nil {
					return fmt.Errorf(`failed to decode value for key %s: %w`, DilithiumXKey, err)
				}
			case X509CertChainKey:
...
func (h dilithiumPublicKey) MarshalJSON() ([]byte, error) {
	data := make(map[string]interface{})
	fields := make([]string, 0, 9)
	data[KeyTypeKey] = jwa.MLWE()
	...
	if h.x != nil {
		data[DilithiumXKey] = h.x
		fields = append(fields, DilithiumXKey)
	}
	if h.x509CertChain != nil {
...
func (h *dilithiumPublicKey) Keys() []string {
	h.mu.RLock()
	defer h.mu.RUnlock()
	...
	if h.x != nil {
		keys = append(keys, DilithiumXKey)
	}
	if h.x509CertChain != nil {
...
var _ DilithiumPrivateKey = &dilithiumPrivateKey{}
var _ Key = &dilithiumPrivateKey{}

func newDilithiumPrivateKey() *dilithiumPrivateKey {
...
func (h dilithiumPrivateKey) KeyType() jwa.KeyType {
	return jwa.MLWE()
}

func (h dilithiumPrivateKey) IsPrivate() bool {
	return true
}

func (h *dilithiumPrivateKey) Algorithm() (jwa.KeyAlgorithm, bool) {
	if h.algorithm != nil {
		return *(h.algorithm), true
	}
	return nil, false
...
func (h *dilithiumPrivateKey) D() ([]byte, bool) {
	if h.d != nil {
		return h.d, true
	}
	return nil, false
...
func (h *dilithiumPrivateKey) KeyID() (string, bool) {
	if h.keyID != nil {
		return *(h.keyID), true
	}
	return "", false
...
func (h *dilithiumPrivateKey) KeyOps() (KeyOperationList, bool) {
	if h.keyOps != nil {
		return *(h.keyOps), true
	}
	return nil, false
...
func (h *dilithiumPrivateKey) KeyUsage() (string, bool) {
	if h.keyUsage != nil {
		return *(h.keyUsage), true
	}
	return "", false
...
func (h *dilithiumPrivateKey) X() ([]byte, bool) {
	if h.x != nil {
		return h.x, true
	}
	return nil, false
...
func (h *dilithiumPrivateKey) X509CertChain() (*cert.Chain, bool) {
	return h.x509CertChain, true
}

func (h *dilithiumPrivateKey) X509CertThumbprint() (string, bool) {
	if h.x509CertThumbprint != nil {
		return *(h.x509CertThumbprint), true
	}
	return "", false
...
func (h *dilithiumPrivateKey) X509CertThumbprintS256() (string, bool) {
	if h.x509CertThumbprintS256 != nil {
		return *(h.x509CertThumbprintS256), true
	}
	return "", false
...
func (h *dilithiumPrivateKey) X509URL() (string, bool) {
	if h.x509URL != nil {
		return *(h.x509URL), true
	}
	return "", false
...
func (h *dilithiumPrivateKey) Has(name string) bool {
	h.mu.RLock()
	defer h.mu.RUnlock()
	switch name {
	case AlgorithmKey:
...
func (h *dilithiumPrivateKey) Get(name string, dst interface{}) error {
	h.mu.RLock()
	defer h.mu.RUnlock()
	switch name {
	case KeyTypeKey:
		if err := blackmagic.AssignIfCompatible(dst, h.KeyType()); err != nil {
			return fmt.Errorf(`dilithiumPrivateKey.Get: failed to assign value for field %q to destination object: %w`, name, err)
		}
	case AlgorithmKey:
		if h.algorithm == nil {
			return fmt.Errorf(`field %q not found`, name)
...
func (h *dilithiumPrivateKey) Set(name string, value interface{}) error {
	h.mu.Lock()
	defer h.mu.Unlock()
	return h.setNoLock(name, value)
}

func (h *dilithiumPrivateKey) setNoLock(name string, value interface{}) error {
	switch name {
	case "kty":
		return nil
	case AlgorithmKey:
	...
	case DilithiumDKey:
		...
		return fmt.Errorf(`invalid value for %s key: %T`, DilithiumDKey, value)
	case KeyIDKey:
		if v, ok := value.(string); ok {
			h.keyID = &v
			return nil
...
func (k *dilithiumPrivateKey) Remove(key string) error {
	k.mu.Lock()
	defer k.mu.Unlock()
	switch key {
	case AlgorithmKey:
...
func (k *dilithiumPrivateKey) Clone() (Key, error) {
	key, err := cloneKey(k)
	if err != nil {
		return nil, fmt.Errorf(`dilithiumPrivateKey.Clone: %w`, err)
	}
	return key, nil
}

func (k *dilithiumPrivateKey) DecodeCtx() json.DecodeCtx {
	k.mu.RLock()
	defer k.mu.RUnlock()
	return k.dc
}

func (k *dilithiumPrivateKey) SetDecodeCtx(dc json.DecodeCtx) {
	k.mu.Lock()
	defer k.mu.Unlock()
	k.dc = dc
}

func (h *dilithiumPrivateKey) UnmarshalJSON(buf []byte) error {
	h.mu.Lock()
	defer h.mu.Unlock()
	h.algorithm = nil
	h.d = nil
		...
		case string: // Objects can only have string keys
			...
			case DilithiumDKey:
				if err := json.AssignNextBytesToken(&h.d, dec); err != nil {
					return fmt.Errorf(`failed to decode value for key %s: %w`, DilithiumDKey, err)
				}
			case KeyIDKey:
				if err := json.AssignNextStringToken(&h.keyID, dec); err != nil {
					return fmt.Errorf(`failed to decode value for key %s: %w`, KeyIDKey, err)
...
func (h dilithiumPrivateKey) MarshalJSON() ([]byte, error) {
	data := make(map[string]interface{})
	...
	if h.d != nil {
		data[DilithiumDKey] = h.d
		fields = append(fields, DilithiumDKey)
	}
	if h.keyID != nil {
		data[KeyIDKey] = *(h.keyID)
		fields = append(fields, KeyIDKey)
...
func (h *dilithiumPrivateKey) Keys() []string {
	h.mu.RLock()
	defer h.mu.RUnlock()
	...
	if h.d != nil {
		keys = append(keys, DilithiumDKey)
	}
	if h.keyID != nil {
		keys = append(keys, KeyIDKey)
	}
