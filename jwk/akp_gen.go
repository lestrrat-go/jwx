...
func (h *akpPublicKey) MarshalJSON() ([]byte, error) {
	...
	if h.pub != nil {
		data[AKPPubKey] = h.pub
		fields = append(fields, AKPPubKey)
	}
	if h.x509CertChain != nil {
...
func (h *akpPrivateKey) MarshalJSON() ([]byte, error) {
	...
	if h.priv != nil {
		data[AKPPrivKey] = h.priv
		fields = append(fields, AKPPrivKey)
	}
	if h.pub != nil {
		data[AKPPubKey] = h.pub
		fields = append(fields, AKPPubKey)
