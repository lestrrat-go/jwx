...
func (v *okpPrivateKey) DecodeCtx() DecodeCtx {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.dc
}

func (v *okpPrivateKey) SetDecodeCtx(dc DecodeCtx) {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.dc = dc
}

func (v *okpPrivateKey) decodeExtraField(name string, dec *json.Decoder, dst interface{}) error {
	if dc := v.dc; dc != nil {
...
func (v *okpPrivateKey) Get(key string, dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
func (v *okpPrivateKey) getNoLock(key string, dst interface{}, raw bool) error {
	switch key {
	case AlgorithmKey:
...
func (v *okpPrivateKey) Set(key string, value interface{}) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	switch key {
	case AlgorithmKey:
...
func (v *okpPrivateKey) Has(name string) bool {
	switch name {
	case AlgorithmKey:
...
func (v *okpPrivateKey) Keys() []string {
...
func (v *okpPrivateKey) HasAlgorithm() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.algorithm != nil
}
...
func (v *okpPrivateKey) HasKeyID() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyID != nil
}
...
func (v *okpPrivateKey) HasKeyOps() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyOps != nil
}
...
func (v *okpPrivateKey) HasKeyType() bool {
	return true
}

// HasKeyUsage returns true if the field `use` has been populated
func (v *okpPrivateKey) HasKeyUsage() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyUsage != nil
}
...
func (v *okpPrivateKey) HasX509CertChain() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertChain != nil
}
...
func (v *okpPrivateKey) HasX509CertThumbprint() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprint != nil
}
...
func (v *okpPrivateKey) HasX509CertThumbprintS256() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprintS256 != nil
}
...
func (v *okpPrivateKey) HasX509URL() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509URL != nil
}
...
func (v *okpPrivateKey) HasCrv() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.crv != nil
}
...
func (v *okpPrivateKey) HasD() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.d != nil
}
...
func (v *okpPrivateKey) HasX() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x != nil
}

func (v *okpPrivateKey) Algorithm() jwa.KeyAlgorithm {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.algorithm; val != nil {
		return *val
...
func (v *okpPrivateKey) KeyID() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyID; val != nil {
		return *val
...
func (v *okpPrivateKey) KeyOps() KeyOperationList {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyOps; val != nil {
		return *val
...
func (v *okpPrivateKey) KeyType() jwa.KeyType {
	return jwa.OKP
}

func (v *okpPrivateKey) KeyUsage() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyUsage; val != nil {
		return val.Get()
...
func (v *okpPrivateKey) X509CertChain() *cert.Chain {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertChain; val != nil {
		return val
...
func (v *okpPrivateKey) X509CertThumbprint() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprint; val != nil {
		return *val
...
func (v *okpPrivateKey) X509CertThumbprintS256() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprintS256; val != nil {
		return *val
...
func (v *okpPrivateKey) X509URL() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509URL; val != nil {
		return *val
...
func (v *okpPrivateKey) Crv() jwa.EllipticCurveAlgorithm {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.crv; val != nil {
		return *val
...
func (v *okpPrivateKey) Remove(key string) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *okpPrivateKey) Clone(dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
	...
	return blackmagic.AssignIfCompatible(dst, &okpPrivateKey{
...
// MarshalJSON serializes okpPrivateKey into JSON.
// All pre-declared fields are included as long as a value is
// assigned to them, as well as all extra fields. All of these
// fields are sorted in alphabetical order.
func (v *okpPrivateKey) MarshalJSON() ([]byte, error) {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
// UnmarshalJSON deserializes a piece of JSON data into okpPrivateKey.
//
...
func (v *okpPrivateKey) UnmarshalJSON(data []byte) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.algorithm = nil
	v.keyID = nil
	...
	for {
		...
		case string:
			...
			case OKPCrvKey:
				...
				if err := dec.Decode(&val); err != nil {
					return fmt.Errorf(`failed to decode value for %q: %w`, OKPCrvKey, err)
				}
				v.crv = &val
			case OKPDKey:
				var val byteslice.Type
				if err := dec.Decode(&val); err != nil {
					return fmt.Errorf(`failed to decode value for %q: %w`, OKPDKey, err)
				}
				v.d = &val
			case OKPXKey:
				var val byteslice.Type
				if err := dec.Decode(&val); err != nil {
					return fmt.Errorf(`failed to decode value for %q: %w`, OKPXKey, err)
				}
				v.x = &val
			default:
				var val interface{}
