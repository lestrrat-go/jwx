...
type ECDSAPrivateKey interface {
	...
	// FromRaw initializes the key internals from a Go native key type of *ecdsa.PrivateKey
...
func (v *ecdsaPrivateKey) DecodeCtx() DecodeCtx {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.dc
}

func (v *ecdsaPrivateKey) SetDecodeCtx(dc DecodeCtx) {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.dc = dc
}

func (v *ecdsaPrivateKey) decodeExtraField(name string, dec *json.Decoder, dst interface{}) error {
	if dc := v.dc; dc != nil {
...
func (v *ecdsaPrivateKey) Get(key string, dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
func (v *ecdsaPrivateKey) getNoLock(key string, dst interface{}, raw bool) error {
	switch key {
	case AlgorithmKey:
...
func (v *ecdsaPrivateKey) Set(key string, value interface{}) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	switch key {
	case AlgorithmKey:
...
func (v *ecdsaPrivateKey) Has(name string) bool {
	switch name {
	case AlgorithmKey:
...
func (v *ecdsaPrivateKey) FieldNames() []string {
...
func (v *ecdsaPrivateKey) HasAlgorithm() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.algorithm != nil
}
...
func (v *ecdsaPrivateKey) HasKeyID() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyID != nil
}
...
func (v *ecdsaPrivateKey) HasKeyOps() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyOps != nil
}
...
func (v *ecdsaPrivateKey) HasKeyType() bool {
	return true
}

// HasKeyUsage returns true if the field `use` has been populated
func (v *ecdsaPrivateKey) HasKeyUsage() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.keyUsage != nil
}
...
func (v *ecdsaPrivateKey) HasX509CertChain() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertChain != nil
}
...
func (v *ecdsaPrivateKey) HasX509CertThumbprint() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprint != nil
}
...
func (v *ecdsaPrivateKey) HasX509CertThumbprintS256() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509CertThumbprintS256 != nil
}
...
func (v *ecdsaPrivateKey) HasX509URL() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x509URL != nil
}
...
func (v *ecdsaPrivateKey) HasCrv() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.crv != nil
}
...
func (v *ecdsaPrivateKey) HasD() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.d != nil
}
...
func (v *ecdsaPrivateKey) HasX() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.x != nil
}
...
func (v *ecdsaPrivateKey) HasY() bool {
	v.mu.RLock()
	defer v.mu.RUnlock()
	return v.y != nil
}

func (v *ecdsaPrivateKey) Algorithm() jwa.KeyAlgorithm {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.algorithm; val != nil {
		return val
...
func (v *ecdsaPrivateKey) KeyID() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyID; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) KeyOps() KeyOperationList {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyOps; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) KeyType() jwa.KeyType {
	return jwa.EC
}

func (v *ecdsaPrivateKey) KeyUsage() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.keyUsage; val != nil {
		return val.Get()
...
func (v *ecdsaPrivateKey) X509CertChain() *cert.Chain {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertChain; val != nil {
		return val
...
func (v *ecdsaPrivateKey) X509CertThumbprint() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprint; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) X509CertThumbprintS256() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509CertThumbprintS256; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) X509URL() string {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.x509URL; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) Crv() jwa.EllipticCurveAlgorithm {
	v.mu.RLock()
	defer v.mu.RUnlock()
	if val := v.crv; val != nil {
		return *val
...
func (v *ecdsaPrivateKey) Remove(key string) error {
	v.mu.Lock()
	defer v.mu.Unlock()
...
func (v *ecdsaPrivateKey) Clone(dst interface{}) error {
	v.mu.RLock()
	defer v.mu.RUnlock()
	...
	return blackmagic.AssignIfCompatible(dst, &ecdsaPrivateKey{
...
// MarshalJSON serializes ecdsaPrivateKey into JSON.
// All pre-declared fields are included as long as a value is
// assigned to them, as well as all extra fields. All of these
// fields are sorted in alphabetical order.
func (v *ecdsaPrivateKey) MarshalJSON() ([]byte, error) {
	v.mu.RLock()
	defer v.mu.RUnlock()
...
// UnmarshalJSON deserializes a piece of JSON data into ecdsaPrivateKey.
//
...
func (v *ecdsaPrivateKey) UnmarshalJSON(data []byte) error {
	v.mu.Lock()
	defer v.mu.Unlock()
	v.algorithm = nil
	v.keyID = nil
	...
	for {
		...
		case string:
			...
			case ECDSACrvKey:
				var acceptValue interface{}
				if err := dec.Decode(&acceptValue); err != nil {
					return fmt.Errorf(`failed to decode vlaue for %q: %w`, ECDSACrvKey, err)
				}
				var val jwa.EllipticCurveAlgorithm
				err = val.Accept(acceptValue)
				if err != nil {
					return fmt.Errorf(`failed to accept value for %q: %w`, ECDSACrvKey, err)
				}
				v.crv = &val
			case ECDSADKey:
				var acceptValue interface{}
