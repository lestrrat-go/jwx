...
func (m *mockHPKEPublicKey) EncryptHPKE(cek []byte, alg, calg string) ([]byte, []byte, error) {
	if m.err != nil {
...
func (m *mockHPKEPrivateKey) DecryptHPKE(sealedCEK []byte, alg, calg string, enc []byte) ([]byte, error) {
	if m.err != nil {
		return nil, m.err
	}
	return m.cek, nil
