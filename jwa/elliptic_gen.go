...
// RegisterEllipticCurveAlgorithmWithOptions is the same as RegisterEllipticCurveAlgorithm when used without options,
...
func RegisterEllipticCurveAlgorithmWithOptions(v EllipticCurveAlgorithm, options ...RegisterAlgorithmOption) error {
