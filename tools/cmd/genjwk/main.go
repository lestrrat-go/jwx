...
func generateGenericHeaders(fields codegen.FieldList) error {
	...
	o.L("Validate() error")
	o.LL("// Raw creates the corresponding raw key from the jwk.Key. For example,")
	o.L("// EC keys would create *ecdsa.PublicKey or *ecdsa.PrivateKey,")
	...
	o.L("// empty interface as the first argument (important caveat: this can only")
	o.L("// be done for keys that are defined in this package. If you are using keys")
	o.L("// imported from third party modules, you will need to know the exact type")
	o.L("// before calling this method).")
