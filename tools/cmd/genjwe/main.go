...
func generateHeaders(obj *codegen.Object) error {
	...
	o.LL("type headerPair struct {")
	o.L("Name  string")
	o.L("Value any")
	o.L("}")

	o.LL("var headerPairPool = sync.Pool{")
	o.L("New: func() any {")
	o.L("return make([]headerPair, 0, %d)", len(obj.Fields()))
	o.L("},")
	o.L("}")

	o.LL("func getHeaderPairList() []headerPair {")
	o.L("return headerPairPool.Get().([]headerPair)")
	o.L("}")

	o.LL("func putHeaderPairList(list []headerPair) {")
	o.L("list = list[:0]")
	o.L("headerPairPool.Put(list)")
	o.L("}")

	o.LL("func (h *stdHeaders) makePairs() ([]headerPair, error) {")
	o.L("pairs := getHeaderPairList()")
	o.L("h.mu.RLock()")
	o.L("defer h.mu.RUnlock()")
	for _, f := range obj.Fields() {
		o.L("if h.%s != nil {", f.Name(false))
		...
		o.L("if err != nil {")
		o.L("return nil, fmt.Errorf(`failed to marshal field %%q: %%w`, %sKey, err)", f.Name(true))
		o.L("}")
		o.L("pairs = append(pairs, headerPair{Name: %sKey, Value: v})", f.Name(true))
		o.L("}")
	}
	...
	o.L("}")
	o.L("}")
	o.L("pairs = append(pairs, headerPair{Name: k, Value: encoded})")
	o.L("}")
