...
// payload.
//
// On verify, the first return value of `jws.Verify()` is nil when this
// option is used, because the payload was streamed from the caller
// rather than extracted from the JWS envelope.
//
