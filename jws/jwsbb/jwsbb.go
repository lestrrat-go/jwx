...
import "github.com/lestrrat-go/dsig"
...
func RegisterDsigAlgorithm(alg string, dsigAlg string) error {
	jwsTodsigAlgMapping[alg] = dsigAlg
	return nil
}

// jwsTodsigAlgMapping maps JWS algorithm names to dsig algorithm names
var jwsTodsigAlgMapping = map[string]string{
	// HMAC algorithms
