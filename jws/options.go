...
//
// RFC 7518 Section 3.4 binds each of ES256/ES384/ES512 to one elliptic curve
...
//
// A malformed (wrong-length) ed25519.PrivateKey/PublicKey causes
// `jws.Sign()`/`jws.Verify()` to return an error rather than panicking.
//
