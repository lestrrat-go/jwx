...
func generateAlg(t Algorithm) error {
	...
	generateAlgImports(o, t)
	generateAlgGlobalState(o, t)
	generateAlgInit(o, t)
	if err := generateAlgAccessors(o, t); err != nil {
		return err
	}
...
func generateAlgTest(t Algorithm) error {
	...
	generateAlgTestLookupAndUnmarshal(o, t, valids)
	generateAlgTestInvalidUnmarshal(o, t)
	generateAlgTestSymmetric(o, t)
