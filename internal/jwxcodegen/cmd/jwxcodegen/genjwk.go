...
func generateKeyInterfaceDef(o *codegen.Output, fields codegen.FieldList) {
	...
	o.L("// hashing algorithm, according to RFC 7638. An error is returned if the")
	o.L("// hash is unavailable (e.g. crypto.Hash(0) or a hash whose package has")
	o.L("// not been imported); it does not panic.")
