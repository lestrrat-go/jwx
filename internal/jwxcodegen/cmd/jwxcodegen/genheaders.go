...
func generateHeaders(cfg *HeaderConfig, obj *codegen.Object) error {
	...
	o.L("Value any")
	o.L("}")
	o.LL("type fieldPairList struct {")
	o.L("pairs []fieldPair")
	o.L("}")
	o.LL("var fieldPairPool = sync.Pool{")
	o.L("New: func() any {")
	o.L("return &fieldPairList{pairs: make([]fieldPair, 0, 16)}")
	o.L("},")
	o.L("}")
	o.LL("func getFieldPairList() *fieldPairList {")
	o.L("//nolint:forcetypeassert")
	o.L("return fieldPairPool.Get().(*fieldPairList)")
	o.L("}")
	o.LL("func putFieldPairList(l *fieldPairList) {")
	o.L("l.pairs = l.pairs[:0]")
	o.L("fieldPairPool.Put(l)")
	o.L("}")
	...
	o.L("defer putFieldPairList(l)")
	o.L("h.mu.RLock()")
	for _, f := range obj.Fields() {
		o.L("if h.%s != nil {", f.Name(false))
		if jwxcodegen.FieldStorageTypeIsIndirect(f) {
			o.L("l.pairs = append(l.pairs, fieldPair{Name: %sKey, Value: *(h.%s)})", f.Name(true), f.Name(false))
		} else {
			o.L("l.pairs = append(l.pairs, fieldPair{Name: %sKey, Value: h.%s})", f.Name(true), f.Name(false))
		}
		o.L("}")
	...
	o.L("l.pairs = append(l.pairs, fieldPair{Name: k, Value: v})")
	o.L("}")
	o.L("h.mu.RUnlock()")
	o.L("slices.SortFunc(l.pairs, fieldPairLess)")
	...
	o.L("}")
	o.L("buf.WriteByte('}')")
	o.L("return bytes.Clone(buf.Bytes()), nil")
	o.L("}")
